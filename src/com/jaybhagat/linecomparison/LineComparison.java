...
/*
 * class to model a two line based on a point consisting of (x, y) co-ordinates using the Cartesian system
 * to calculate length of the two line to check if one line is equal, greater or less than the other line.
